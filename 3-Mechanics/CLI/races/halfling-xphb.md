...
You have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on saving throws you make to avoid or end the [Frightened](conditions.md#Frightened) condition.
