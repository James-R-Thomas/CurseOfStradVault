...
- **Dampening Field**  
    ...
    You have advantage on Dexterity ([Stealth](skills.md#Stealth)) checks. If the armor normally imposes disadvantage on such checks, the advantage and disadvantage cancel each other, as normal.  
