...
As a [Magic](actions.md#Magic) action while entirely within [Dim Light](/3-Mechanics/CLI/variant-rules/dim-light-xphb.md) or [Darkness](/3-Mechanics/CLI/variant-rules/darkness-xphb.md), you can expend 3 Focus Points to shroud yourself with shadows for 1 minute, until you have the [Incapacitated](conditions.md#Incapacitated) condition, or until you end your turn in [Bright Light](/3-Mechanics/CLI/variant-rules/bright-light-xphb.md). While shrouded by these shadows, you gain the following benefits.
