...
You gain [Expertise](/3-Mechanics/CLI/variant-rules/expertise-xphb.md) in two of your skill proficiencies of your choice. [Sleight of Hand](skills.md#Sleight%20of%20Hand) and [Stealth](skills.md#Stealth) are recommended if you have proficiency in them.
...
You don't need [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) on the attack roll if at least one of your allies is within 5 feet of the target, the ally doesn't have the [Incapacitated](conditions.md#Incapacitated) condition, and you don't have [Disadvantage](/3-Mechanics/CLI/variant-rules/disadvantage-xphb.md) on the attack roll.
...
Your quick thinking and agility allow you to move and act quickly. On your turn, you can take one of the following actions as a [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md): [Dash](actions.md#Dash), [Disengage](actions.md#Disengage), or [Hide](actions.md#Hide).
...
Immediately after the attack, you move up to half your [Speed](/3-Mechanics/CLI/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](actions.md#Opportunity%20Attack).
...
You're so evasive that attackers rarely gain the upper hand against you. No attack roll can have [Advantage](/3-Mechanics/CLI/variant-rules/advantage-xphb.md) against you unless you have the [Incapacitated](conditions.md#Incapacitated) condition.
