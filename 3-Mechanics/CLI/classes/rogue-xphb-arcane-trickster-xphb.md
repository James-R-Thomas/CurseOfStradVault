...
When you cast [Mage Hand](/3-Mechanics/CLI/spells/mage-hand-xphb.md), you can cast it as a [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md), and you can make the spectral hand [Invisible](conditions.md#Invisible). You can control the hand as a [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md), and through it, you can make Dexterity ([Sleight of Hand](skills.md#Sleight%20of%20Hand)) checks.

### Magical Ambush (Level 9)

If you have the [Invisible](conditions.md#Invisible) condition when you cast a spell on a creature, it has [Disadvantage](/3-Mechanics/CLI/variant-rules/disadvantage-xphb.md) on any saving throw it makes against the spell on the same turn.
