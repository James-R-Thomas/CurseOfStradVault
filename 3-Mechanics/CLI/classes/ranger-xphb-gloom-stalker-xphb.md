...
You are also adept at evading creatures that rely on [Darkvision](senses.md#Darkvision). While entirely in [Darkness](/3-Mechanics/CLI/variant-rules/darkness-xphb.md), you have the [Invisible](conditions.md#Invisible) condition to any creature that relies on [Darkvision](senses.md#Darkvision) to see you in that [Darkness](/3-Mechanics/CLI/variant-rules/darkness-xphb.md).
