...
As a [Magic](actions.md#Magic) action, you can give yourself a number of [Temporary Hit Points](/3-Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md) equal to `dice:1d8|noform|noparens|avg` (`d8`) plus your Wisdom modifier (minimum of 1). You can use this action a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a [Long Rest](/3-Mechanics/CLI/variant-rules/long-rest-xphb.md).

#### Decrease Exhaustion

Whenever you finish a [Short Rest](/3-Mechanics/CLI/variant-rules/short-rest-xphb.md), your [Exhaustion](conditions.md#Exhaustion) level, if any, decreases by 1.
...
You invoke spirits of nature to magically hide yourself. As a [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md), you can give yourself the [Invisible](conditions.md#Invisible) condition until the end of your next turn.
