...
You can summon a nature spirit that assumes an animal form to aid you. As a [Magic](actions.md#Magic) action, you can expend a spell slot or a use of Wild Shape to cast the [Find Familiar](/3-Mechanics/CLI/spells/find-familiar-xphb.md) spell without Material components.
