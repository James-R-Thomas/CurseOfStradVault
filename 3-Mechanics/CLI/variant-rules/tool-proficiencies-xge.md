...
Proficiency with [alchemist's supplies](/3-Mechanics/CLI/items/alchemists-supplies-xphb.md) allows you to unlock more information on [Arcana](skills.md#Arcana) checks involving potions and similar materials.
...
Proficiency with [brewer's supplies](/3-Mechanics/CLI/items/brewers-supplies-xphb.md) gives you additional insight on Intelligence ([History](skills.md#History)) checks concerning events that involve alcohol as a significant element.
...
With 8 hours of work, you can add a hidden compartment to a pair of shoes. The compartment can hold an object up to 3 inches long and 1 inch wide and deep. You make an Intelligence check using your tool proficiency to determine the Intelligence ([Investigation](skills.md#Investigation)) check DC needed to find the compartment.
...
A [forgery kit](/3-Mechanics/CLI/items/forgery-kit-xphb.md) can be used in conjunction with the [Arcana](skills.md#Arcana) skill to determine if a magic item is real or fake.
...
As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](/3-Mechanics/CLI/items/forgery-kit-xphb.md) determines the DC for someone else's Intelligence ([Investigation](skills.md#Investigation)) check to spot the fake.
...
[Sleight of Hand](skills.md#Sleight%20of%20Hand) is a useful skill for cheating at a game, as it allows you to swap pieces, palm cards, or alter a die roll. Alternatively, engrossing a target in a game by manipulating the components with dexterous movements is a great distraction for a pickpocketing attempt.
...
Proficiency with [jeweler's tools](/3-Mechanics/CLI/items/jewelers-tools-xphb.md) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](skills.md#Arcana) checks related to gems or gem-encrusted items.
