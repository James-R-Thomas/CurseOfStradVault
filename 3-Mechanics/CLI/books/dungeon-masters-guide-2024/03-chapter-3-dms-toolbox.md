...
A chase participant can take the [Dash](actions.md#Dash) action a number of times equal to 3 plus its Constitution modifier (minimum of once). Each additional Dash action it takes during the chase requires the creature to succeed on a DC 10 Constitution saving throw at the end of its turn or gain 1 [Exhaustion](conditions.md#Exhaustion) level. A participant drops out of the chase if it has 5 [Exhaustion](conditions.md#Exhaustion) levels. A creature can remove the [Exhaustion](conditions.md#Exhaustion) levels it gained during the chase by finishing a [Short](/3-Mechanics/CLI/variant-rules/short-rest-xphb.md) or [Long Rest](/3-Mechanics/CLI/variant-rules/long-rest-xphb.md).
...
- **Steadfast.** The creature has [Immunity](/3-Mechanics/CLI/variant-rules/immunity-xphb.md) to the [Frightened](conditions.md#Frightened) condition while it can see an ally within 30 feet of itself.  
...
The character has 1 Hit Point and the [Unconscious](conditions.md#Unconscious) condition. The character can regain Hit Points as normal, but the character remains Unconscious until they are targeted by a [Greater Restoration](/3-Mechanics/CLI/spells/greater-restoration-xphb.md) spell or experience a sudden awakening (see below).
...
The character has the [Frightened](conditions.md#Frightened), [Incapacitated](conditions.md#Incapacitated), or [Stunned](conditions.md#Stunned) condition for `dice:1d10|noform|noparens|avg` (`d10`) minutes. This condition might be accompanied by alarming behavior or hallucinations. These effects can be suppressed with the [Calm Emotions](/3-Mechanics/CLI/spells/calm-emotions-xphb.md) spell or removed by the [Lesser Restoration](/3-Mechanics/CLI/spells/lesser-restoration-xphb.md) spell.
...
A character can attempt to harvest poison from a venomous creature that is dead or has the [Incapacitated](conditions.md#Incapacitated) condition. The effort takes `dice:1d6|noform|noparens|avg` (`d6`) minutes, after which the character makes a DC 20 Intelligence ([Nature](skills.md#Nature)) check using a [Poisoner's Kit](/3-Mechanics/CLI/items/poisoners-kit-xphb.md). On a successful check, the character harvests enough poison for a single dose, and no additional poison can be harvested from that creature. On a failed check, the character is unable to extract any poison. If the character fails the check by 5 or more, the character is subjected to the creature's poison.
