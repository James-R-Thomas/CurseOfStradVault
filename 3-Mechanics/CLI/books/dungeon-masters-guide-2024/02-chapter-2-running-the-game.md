...
- **Exhaustion.** The obstacle fatigues the characters, causing them to gain [Exhaustion](conditions.md#Exhaustion) levels. For example, marching through a blizzard instead of taking shelter might cause each character to gain `dice:1d4|noform|noparens|avg` (`d4`) [Exhaustion](conditions.md#Exhaustion) levels.  
...
- The monster starts its turn [Bloodied](/3-Mechanics/CLI/variant-rules/bloodied-xphb.md) and more than half its allies are dead or have the [Incapacitated](conditions.md#Incapacitated) condition, while no one is dead or Incapacitated on the other side.  
