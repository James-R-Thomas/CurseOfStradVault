...
When a creature moves into the spell's area for the first time on a turn or starts its turn there, that creature must succeed on a Constitution saving throw or take `dice:4d10|noform|noparens|avg` (`4d10`) radiant damage, and it suffers one level of [exhaustion](conditions.md#Exhaustion) and emits a dim, greenish light in a 5-foot radius. This light makes it impossible for the creature to benefit from being [invisible](conditions.md#Invisible). The light and any levels of [exhaustion](conditions.md#Exhaustion) caused by this spell go away when the spell ends.
