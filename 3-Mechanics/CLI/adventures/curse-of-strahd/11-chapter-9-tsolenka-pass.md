...
These statues are actually two [petrified](conditions.md#Petrified) [vrocks](/3-Mechanics/CLI/bestiary/fiend/vrock-xmm.md). If they are attacked, or if the characters bypass the gatehouse, the vrocks revert to flesh and attack, pursuing prey that flees and fighting until slain.
...
The tower door is made of ironbound wood and barred from within. A character can force open the door with a successful DC 22 Strength ([Athletics](skills.md#Athletics)) check.
...
The cloaked rider is a manifestation of [Strahd von Zarovich](NPCs/NPC%20Files/npc/NPC%20Stats/strahd-von-zarovich-cos.md)—a grim warning to proceed no further. If the characters interact with the manifestation in any way, the rider and horse disperse like ash in the wind.
...
As the characters make their way along Tsolenka Pass, they encounter a beast that the druids and berserkers of Barovia call [Sangzor](sangzor-cos.md) ("Bloodhorn"):
...
If no character has a passive Wisdom ([Perception](skills.md#Perception)) score of 16 or higher, the party is [surprised](conditions.md#Surprised). Otherwise, read:
...
[Sangzor](sangzor-cos.md) is a [giant goat](/3-Mechanics/CLI/bestiary/beast/giant-goat-xmm.md) known for its supernatural resilience and evil disposition. Mountain folk have been hunting it for years. Modify its statistics as follows:
...
A character who wears [Sangzor](sangzor-cos.md)'s pelt can command the respect of the berserkers who inhabit Strahd's domain. They will not attack the character or that character's companions unless provoked.