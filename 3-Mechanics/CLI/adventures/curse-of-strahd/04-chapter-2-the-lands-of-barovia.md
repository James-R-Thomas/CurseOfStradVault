...
- A creature that starts its turn in the fog must succeed on a DC 20 Constitution saving throw or gain one level of [exhaustion](conditions.md#Exhaustion) (see "appendix A" in the "Player's Handbook"). This [exhaustion](conditions.md#Exhaustion) can't be removed while the creature is in the fog.  
...
[Ireena Kolyana](ireena-kolyana-cos.md) and her brother Ismark both have souls, as do all Vistani. Which Barovians have souls and which don't is left up to you.
...
- [Strahd von Zarovich](NPCs/NPC%20Files/npc/NPC%20Stats/strahd-von-zarovich-cos.md) is a vampire, and he dwells in Castle Ravenloft. No one is welcome at the castle.  
...
- The town of Vallaki lies in the heart of the valley. Its burgomaster is named [Baron Vargas Vallakovich](baron-vargas-vallakovich-cos.md).  
...
- Some Vistani women are blessed with prescience. Of all the great Vistani fortune-tellers, none compares to [Madam Eva](madam-eva-cos.md). If knowledge of the future is what you seek, [Madam Eva](madam-eva-cos.md) will tell you your fate.  
...
- The target is [blinded](conditions.md#Blinded), [deafened](conditions.md#Deafened), or both. When this curse ends, the Vistana takes `dice:5d6|noform|noparens|avg` (`5d6`) psychic damage.  

### Evil Eye

As an action, a Vistana can target a creature within 10 feet that the Vistana can see. This magical ability, which the Vistani call the Evil Eye, duplicates the duration and effect of the [animal friendship](/3-Mechanics/CLI/spells/animal-friendship-xphb.md), [charm person](/3-Mechanics/CLI/spells/charm-person-xphb.md), or [hold person](/3-Mechanics/CLI/spells/hold-person-xphb.md) spell (Vistana's choice), but requires neither somatic nor material components. The spell save DC is 8 + the caster's proficiency bonus + the caster's Charisma modifier. If the target succeeds on the save, the Vistana is [blinded](conditions.md#Blinded) until the end of the Vistana's next turn.
...
| 3 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [scouts](/3-Mechanics/CLI/bestiary/humanoid/barovian-scout-cos.md) |
| 4 | Hunting trap |
| 5 | Grave |
| 6 | False trail |
...
| 9 | Trinket |
| 10 | Hidden bundle |
| 11 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [swarm of ravens](/3-Mechanics/CLI/bestiary/beast/swarm-of-ravens-xmm.md) (50%) or 1 [wereraven](/3-Mechanics/CLI/bestiary/humanoid/wereraven-vrgr.md) (see appendix D) in raven form (50%) |
| 12 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) |
| 13 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) |
| 14 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
| 15 | Corpse |
| 16 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) in human form |
...
| 19 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [scarecrows](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) |
...
| 7 | Hidden bundle |
| 8 | Skeletal rider |
| 9 | `dice:1d8\|noform\|noparens\|avg` (`d8`) [swarm of bats](/3-Mechanics/CLI/bestiary/beast/swarm-of-bats-xmm.md) |
| 10 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) |
| 11 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) |
| 12 | `dice:1d4\|noform\|noparens\|avg` (`d4`) [berserkers](/3-Mechanics/CLI/bestiary/humanoid/berserker-xmm.md) |
...
| 15 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [werewolves](/3-Mechanics/CLI/bestiary/monstrosity/werewolf-xmm.md) in wolf form |
| 16 | `dice:3d6\|noform\|noparens\|avg` (`3d6`) [zombies](/3-Mechanics/CLI/bestiary/undead/zombie-xmm.md) |
| 17 | `dice:1d6\|noform\|noparens\|avg` (`d6`) [scarecrows](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) |
| 18 | `dice:1d8\|noform\|noparens\|avg` (`d8`) [Strahd zombies](/3-Mechanics/CLI/bestiary/undead/strahd-zombie-cos.md) (see appendix D) |
...
If at least one character has a passive Wisdom ([Perception](skills.md#Perception)) score of 16 or higher, read:
...
The area is lightly obscured by fog. If more than one dire wolf is present, the others aren't far behind and can be seen as dark shadows in the fog. The [dire wolves](/3-Mechanics/CLI/bestiary/beast/dire-wolf-xmm.md) of Barovia are cruel, overgrown wolves and Strahd's loyal servants. They can't be [charmed](conditions.md#Charmed) or [frightened](conditions.md#Frightened).
...
Have each of the characters in the front rank of the party's marching order make a DC 15 Wisdom ([Survival](skills.md#Survival)) check. If one or more of them succeeds, read:
...
From a distance, the [revenant](/3-Mechanics/CLI/bestiary/undead/revenant-xmm.md) looks like a zombie and might be mistaken for such. A character within 30 feet of the revenant who succeeds on a DC 10 Wisdom ([Insight](skills.md#Insight)) check can see the intelligence and hate in its sunken eyes. The revenant is clad in tattered chain mail that affords the same protection as leather armor.
...
If the characters present themselves as enemies of Strahd, the revenant urges them to travel to Argynvostholt (chapter 7) and convince [Vladimir Horngaard](vladimir-horngaard-cos.md), the leader of the Order of the Silver Dragon, to help them. The revenant would like nothing more than to kill Strahd, but it will not venture to Castle Ravenloft unless it receives orders to do so from Vladimir. If the characters ask the revenant to lead them to Horngaard in Argynvostholt, it does so while avoiding contact with Barovian settlements.

### Scarecrows

If at least one character has a passive Wisdom ([Perception](skills.md#Perception)) score of 11 or higher, read:
...
If more than one [scarecrow](/3-Mechanics/CLI/bestiary/construct/scarecrow-xmm.md) is present, the others are close by. If none of the characters has a passive Wisdom ([Perception](skills.md#Perception)) score of 11 or higher, the scarecrows catch the party by surprise.

[Baba Lysaga](baba-lysaga-cos.md) (see chapter 10, area U3) crafted these scarecrows to hunt down and kill ravens and wereravens. The scarecrows are imbued with evil spirits and delight in murdering anyone they encounter.
...
This [wereraven](/3-Mechanics/CLI/bestiary/humanoid/wereraven-vrgr.md) in raven form watches the characters from a distance. Compare its Dexterity ([Stealth](skills.md#Stealth)) check result to the characters' passive Wisdom ([Perception](skills.md#Perception)) scores to see whether it remains hidden from the party.
...
Werewolves in wolf form follow the party from a safe distance for several hours. If their Dexterity ([Stealth](skills.md#Stealth)) checks exceed the characters' passive Wisdom ([Perception](skills.md#Perception)) scores, the werewolves attack with surprise when the characters decide to take a short or long rest. Otherwise, they wait until the characters are weakened by another random encounter before moving in for the easy kill.
...
The light is a [will-o'-wisp](/3-Mechanics/CLI/bestiary/undead/will-o-wisp-xmm.md) that enters the ruined tower and becomes [invisible](conditions.md#Invisible), hoping to lure the characters inside to their doom.
...
Characters have a few minutes to steel themselves before these [wolves](/3-Mechanics/CLI/bestiary/beast/wolf-xmm.md) attack. They heed the will of Strahd and can't be [charmed](conditions.md#Charmed) or [frightened](conditions.md#Frightened).
...
> 
> **Secret Doors.** If there are obvious clues to a secret door's presence, such as scratch marks on a nearby wall or footprints leading to it, a character with a passive Wisdom ([Perception](skills.md#Perception)) score of 15 or higher notices the secret door. Otherwise, finding a secret door requires a search of the area and a successful DC 15 Wisdom ([Perception](skills.md#Perception)) check.
> 
...
If the characters are following the road on foot, the party member who has the highest passive Wisdom ([Perception](skills.md#Perception)) score notices something:
...
The Vistana storyteller doesn't remember the wizard's name, but recalls that it sounded important. If the characters haven't spoken with [Madam Eva](madam-eva-cos.md), the storyteller urges them to do so.

#### Madam Eva's Tent

If the characters decide to see [Madam Eva](madam-eva-cos.md), read:
...
If your card reading reveals that a treasure is here, it is hidden in one of the Vistani wagons. [Madam Eva](madam-eva-cos.md) grants the characters permission to search the wagons if they ask, and any such search yields the treasure.
...
A patch of [green slime](/3-Mechanics/CLI/traps-hazards/green-slime-xdmg.md) (see ""Dungeon Hazards"" in chapter 5 of the "Dungeon Master's Guide") clings to the portcullis in the entry tunnel, and can be spotted with a successful DC 20 Wisdom ([Perception](skills.md#Perception)) check. The slime will not fall on characters entering the castle, but it does fall on the first character who leaves by this route.

### K. Castle Ravenloft

Chapter 4 explores Castle Ravenloft, lair of the vampire [Strahd von Zarovich](NPCs/NPC%20Files/npc/NPC%20Stats/strahd-von-zarovich-cos.md).
...
Each rowboat can safely hold five people. The person fishing on the lake is [Bluto Krogarov](bluto-krogarov-cos.md) (NE male human [commoner](/3-Mechanics/CLI/bestiary/humanoid/commoner-xmm.md)), a resident of Vallaki. He is in a trance and doesn't respond to anything or anyone unless attacked. His boat is 400 feet from the nearest shore. Tied up in the boat is a seven-year-old Vistana named [Arabelle](arabelle-cos.md) (LN female human [commoner](/3-Mechanics/CLI/bestiary/humanoid/vistana-commoner-cos.md) with 2 hit points and no effective attacks). She is bound with hempen rope, wrapped in a burlap sack, and lying [prone](conditions.md#Prone) so that she can't be seen or heard from the shore.

#### Roleplaying Bluto

[Bluto Krogarov](bluto-krogarov-cos.md) is a destitute drunkard. He's desperate to catch some fish and trade them for wine at the Blue Water Inn. After he was unable to catch a single fish for a week, he kidnapped [Arabelle](arabelle-cos.md), believing that Vistani are lucky. He intends to sacrifice her to the lake, hoping it will give up some of its fish in return.
...
Characters who act quickly can save [Arabelle](arabelle-cos.md) before she drowns. A character on the shore must succeed on a DC 15 Strength ([Athletics](skills.md#Athletics)) check to reach her in time. The DC is 10 for characters who took a rowboat out onto the lake.

[Arabelle](arabelle-cos.md) has alabaster-white skin and raven-black hair. If rescued, she demands to be returned to her family's camp outside Vallaki (chapter 5, area N9). She is certain that her father, [Luvash](luvash-cos.md), will give the characters a reward for doing so.

A descendant of [Madam Eva](madam-eva-cos.md) with the blood of Barovian royalty in her veins, [Arabelle](arabelle-cos.md) is unaware of her connection to Strahd. She acts more like an adult than a child. Despite her recent misadventure, she believes that a great destiny awaits her.
...
[The Mad Mage of Mount Baratok](the-mad-mage-of-mount-baratok-cos.md) (CN male human [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md)) came to Barovia more than a year ago to free its people from Strahd's tyranny, but he underestimated Strahd's hold over the land and the creatures in it. After a battle between the two in Castle Ravenloft, Strahd drove the Mad Mage to the mountains and sent the wizard hurling over Tser Falls (area H). The wizard, his staff and spellbook lost, survived the fall and retreated into the mountains, hoping to regain his power, only to be driven mad by the realization that he no longer has any hope of defeating Strahd or freeing the people of the vampire's damned realm.
...
The [archmage](/3-Mechanics/CLI/bestiary/humanoid/archmage-xmm.md) has never had his fortune read by [Madam Eva](madam-eva-cos.md) and doesn't care to, but if he is told about the [Holy Symbol of Ravenkind](/3-Mechanics/CLI/items/holy-symbol-of-ravenkind-cos.md), the [Tome of Strahd](/3-Mechanics/CLI/items/tome-of-strahd-cos.md), and the [Sunsword](/3-Mechanics/CLI/items/sunsword-cos.md), he insists that these items be recovered before he and the party confront Strahd. If Strahd is defeated and Mordenkainen survives, the archmage gladly accompanies the characters back to their world if they invite him, if only not to disappoint them.
...
Chapter 10 describes the ruins of Berez, a riverside village that is now home to the hag [Baba Lysaga](baba-lysaga-cos.md).
