...
When you make the extra attack of the Light property, you can make it as part of the [Attack](actions.md#Attack) action instead of as a [Bonus Action](/3-Mechanics/CLI/variant-rules/bonus-action-xphb.md). You can make this extra attack only once per turn.
